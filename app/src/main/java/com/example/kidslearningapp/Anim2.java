...
public class Anim2 extends AppCompatActivity implements View.OnClickListener {

    private ConstraintLayout layout;
    TextToSpeech speak;
    TextView tv;
    private Placeholder placeholder;
    String[] numbers = new String[] { "No. it doesn't have three wheels ","correct, auto rickshaw has three wheels","Which vehicle has three wheels"};
