...
public class Anim3 extends AppCompatActivity implements View.OnClickListener {

    private ConstraintLayout layout;
    TextToSpeech speak;
    TextView tv;
    private Placeholder placeholder;
    String[] numbers = new String[] { "No. this fruit is not yellow in colour ","amazing, mango is yellow in colour ","Pick out the fruit which is yellow in colour"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeholder = findViewById(R.id.placeholder3);
