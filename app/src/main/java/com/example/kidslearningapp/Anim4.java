...
public class Anim4 extends AppCompatActivity implements View.OnClickListener {

    private ConstraintLayout layout;
    TextToSpeech speak;
    TextView tv;
    private Placeholder placeholder;
    String[] numbers = new String[] { "No. this bird doesn't swim in water ","great. the duck swims in water ","Which bird swims in water"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeholder = findViewById(R.id.placeholder4);
