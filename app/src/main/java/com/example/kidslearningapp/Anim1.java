...
public class Anim1 extends AppCompatActivity implements View.OnClickListener {

    private ConstraintLayout layout;
    TextToSpeech speak;
    TextView tv;
    private Placeholder placeholder;
    String[] numbers = new String[] { "No. its not a coconut","awesome, it's a coconut","Pick out the coconut"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeholder = findViewById(R.id.placeholder1);
